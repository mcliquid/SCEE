...
val MapColors.Companion.DarkContrast get() = mapColorsDarkContrast
private val mapColorsDarkContrast = mapColorsNight.copy(
    earth = Color(0xff151525),
    water = Color(0xff000060),
    green = Color(0xff375935),
    forest = Color(0xff293f28),
    town = Color.Black,
    building = Color(33, 77, 77, 179),
    buildingOutline = Color(59, 140, 140, 128),
    path = Color(0xff666688),
    roadOutline = Color(0xff9999ff),
    textWaterOutline = Color(0xffaaaacc),
)

/** Semi-transparent vector style drawn on top of an aerial raster background. */
val MapColors.Companion.Aerial get() = mapColorsAerial
private val mapColorsAerial = mapColorsLight.copy(
    earth = Color.Transparent,
    water = Color.Transparent,
    waterShore = Color(0xffaabbee).copy(alpha = 0.4f),
    green = Color.Transparent,
    forest = Color.Transparent,
    town = Color.Transparent,
    building = Color(204, 214, 238, 51),
    buildingOutline = Color(185, 195, 217, 102),
    railway = Color(0xff9999aa).copy(alpha = 0.5f),
    path = Color(0xffffaa88).copy(alpha = 0.2f),
    road = Color.White.copy(alpha = 0.2f),
    roadOutline = Color(0xffccaa99).copy(alpha = 0.5f),
    pedestrian = Color(0xffffaa88).copy(alpha = 0.2f),
    motorway = Color.White.copy(alpha = 0.2f),
    motorwayOutline = Color(0xffccaa99).copy(alpha = 0.5f),
    privateOverlay = Color(0xfff3dacd).copy(alpha = 0.5f),
)
