...
import de.westnordost.streetcomplete.resources.dialog_dont_notify_again2
import de.westnordost.streetcomplete.resources.dialog_session_dont_show_again
...
fun ConfirmSurfaceDialog(
    ...
    AlertDialog(
        ...
        buttons = {
            FlowRow {
                TextButton(onClick = { dontShowAgain = true; onWrongSurface(); onDismissRequest() }) {
