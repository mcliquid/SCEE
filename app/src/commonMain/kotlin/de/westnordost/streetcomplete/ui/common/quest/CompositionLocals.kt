...
/** True while the tag editor form is open. Used by SCEE forms that adapt UI in that context. */
val LocalIsTagEditor = compositionLocalOf<Boolean> { false }

/** Screen offset of a map position, used by forms drawn outside the map (e.g. insert-node crosshair). */
