...
class AddMaxSpeed (
...
) : OsmFilterQuestType<Pair<MaxSpeedAnswer, Pair<String, String>?>>() {
    ...
    @Composable
    override fun Form(on: (QuestAction<Pair<MaxSpeedAnswer, Pair<String, String>?>>) -> Unit, element: Element, geometry: ElementGeometry, countryInfo: CountryInfo) {
