...
class AddRoadWidth(
    ...
    override fun QuestSettings(onDismissRequest: () -> Unit) {
        FullElementSelectionDialog(prefs, questPrefix(prefs) + PREF_ROAD_WIDTH_ELEMENTS, Res.string.quest_settings_element_selection, ROAD_SELECTION.trimIndent(), onDismissRequest)
    }
}
